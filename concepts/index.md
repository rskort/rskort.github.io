...
<div class="concept-grid">
  <a class="concept-card" href="{{ '/concepts/miller-indices/' | relative_url }}"><span>01 · Orientation</span><h2>Miller planes</h2><p>Use axis intercepts to understand exactly where (100), (110), and (111) pass through an FCC unit cell.</p><b>→</b></a>
