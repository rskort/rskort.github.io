(() => {
  ...
  const initialisePlaneDemos = () => {
    document.querySelectorAll("[data-plane-demo]").forEach(root => {
      ...
      const planes = {
        ...
        "110": {
          ...
          description: "The plane meets x and y at one lattice constant and stays parallel to z. The exposed net contains parallel atomic rows separated by wider gaps.",
          accent: "#3b7f86"
        },
        "111": {
