...
An adsorption site names a position relative to atoms in the exposed surface. Common ideal sites are:
...
## Why FCC and HCP hollows differ
...
These sites are reference geometries, not guaranteed energy minima. Adsorbates can relax laterally, tilt, dissociate, or induce reconstruction. Report both the initial named site and the final optimized geometry when they differ.
