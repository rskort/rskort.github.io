...
These sites are reference geometries, not guaranteed energy minima. Adsorbates can relax laterally, tilt, dissociate, penetrate a subsurface pocket, or induce reconstruction. A sensible search starts from several symmetry-distinct candidates, uses consistent settings, and checks the final coordination after optimization.
